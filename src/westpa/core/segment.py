...
class Segment:
    """Stores information about a trajectory segment generated by a simulation.
    ...
    def initpoint_type(self):
        """Named constant from :class:`InitPointType` indicating the segment's origin."""
    ...
    def endpoint_type(self):
        """Named constant from :class:`EndPointType` indicating the segment's fate."""
    ...
    @property
    def status(self):
        """Named constant from :class:`Status` indicating the segment's propagation status."""
        return self._status
